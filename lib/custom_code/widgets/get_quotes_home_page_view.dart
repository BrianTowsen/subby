...
class GetQuotesHomePageView extends StatefulWidget {
  const GetQuotesHomePageView({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<GetQuotesHomePageView> createState() => _GetQuotesHomePageViewState();
}

class _GetQuotesHomePageViewState extends State<GetQuotesHomePageView> {
  // ─── SUBBY PALETTE (LOCK) ──────────────────────────────────────────
  ...
  // ✅ Destination route (Get Quotes page)
  static const String _fallbackGetQuotesRoute = 'getQuotesPage';
  ...
  Color _quotesColour(FlutterFlowTheme theme) {
    // Try FF custom color "GetQuotesColour" -> getQuotesColour
    try {
  ...
  // -----------------------------
  // Subby card shell (for helper blocks / empty blocks)
  // -----------------------------
  ...
  // -----------------------------
  // ✅ Status pill (outlined + dot) — matches MyProjects/Timeline
  // -----------------------------
  ...
  // -----------------------------
  // ✅ Navigate to Get Quotes page
  // -----------------------------
  Future<void> _openGetQuotes() async {
  ...
  // -----------------------------
  // ✅ Project tile/card (MATCHES MyProjects/Timeline)
  // -----------------------------
  Widget _projectTile({
    required FlutterFlowTheme theme,
    required Color accent,
  ...
  // -----------------------------
  // ✅ Active Project Tile (loading / empty / wired)
  // -----------------------------
  Widget _activeProjectTile(FlutterFlowTheme theme, Color accent) {
        ...
        child: Row(
          children: [
            Container(
              ...
              child:
                  Icon(Icons.request_quote_outlined, color: _inkMute, size: 22),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Add a project in My Projects to request quotes.',
                    style:
    ...
    return StreamBuilder<DocumentSnapshot<Object?>>(
      ...
      builder: (context, snap) {
        ...
        if (locationLine.trim().isEmpty) locationLine = 'South Africa';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            'Request pricing from the right suppliers.',
                ...
                _activeProjectTile(theme, quotesColour),
