              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _h2('5. The network and service providers'),
                    _p('Listings in the network are provided by service providers or compiled from available sources. We do not employ, endorse, vet, certify or guarantee any provider, and we are not a party to any agreement you enter into with them.'),
                    _p('You are responsible for satisfying yourself about a provider\'s suitability, qualifications, registrations (for example NHBRC enrolment where applicable), insurance, pricing and references before engaging them. Any contract for building or related work is between you and the provider directly. To the extent permitted by law, Subby is not responsible for the quality, safety, legality or outcome of any work, goods or services arranged through the network.'),
