...
// Subby bottom nav — matches DashboardPageView v4.
// Place at the bottom of your page scaffolds. Set `currentIndex` per page
// (0 Projects · 1 Directory · 2 Activity · 3 Account) so the right tab lights
// up, and pass the FF route names for the tabs you want it to navigate to.
//
...
class MainBottomNav extends StatefulWidget {
  ...
  /// 0 Projects · 1 Directory · 2 Activity · 3 Account
  final int currentIndex;

  final String? projectsRouteName;
  final String? directoryRouteName;
  final String? activityRouteName;
...
class _MainBottomNavState extends State<MainBottomNav> {
  ...
  String? _routeFor(int index) {
    switch (index) {
      ...
      case 2:
        return widget.activityRouteName;
      case 3:
